"""
Django settings for sitio_quantum project.
...
SECRET_KEY = 'django-insecure-jdd@+n&0qc9#929+u%)94zeiin-=bx37qc%bxg=4adg8h+b6gf'
...
ROOT_URLCONF = 'sitio_quantum.urls'
...
WSGI_APPLICATION = 'sitio_quantum.wsgi.application'
